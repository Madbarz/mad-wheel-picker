...
public class NativeWheelPicker extends WheelCrossPicker {
  ...
  public NativeWheelPicker(Context context) {
    super(context);
  }

  public NativeWheelPicker(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
